...
def resolve_url(url):
    ...
    if not stream_url:
        ...
        dialog.notification("Fusion Request", message,
...
if mode is None:
    duration = 17500
    dialog = xbmcgui.Dialog()
    dialog.notification("Shorty TV", 'Mejor que el lugar de los arbolitos felices.',
                        xbmcgui.NOTIFICATION_INFO, duration, False)
    fanart = 'http://darkelite.ml/img/fondo.jpg'
    
	
	url = 'https://raw.githubusercontent.com/xxspokiixx/testkod/master/main.xml'
    li = xbmcgui.ListItem('[COLOR yellow][B]Shorty TV[/B][/COLOR]', iconImage='https://github.com/xxspokiixx/testkod/raw/master/plugin.video.ShortyTV/icon.png',
                          thumbnailImage='https://github.com/xxspokiixx/testkod/raw/master/plugin.video.ShortyTV/icon.png')
    li.setInfo("video", {"Plot": '[COLOR skyblue][B]Contenido piojo.[/B][/COLOR]'})
    ...
    if (kb.isConfirmed()):
        if kb.getText() == '':
            duration = 3500
            dialog = xbmcgui.Dialog()
            dialog.notification("Fusion Request", 'No se detecto nada escrito en el buscador Vuelve a Intentar',
                                xbmcgui.NOTIFICATION_INFO, duration, False)
        else:
            search_term = kb.getText()
    ...
    for match in matches:
        ...
        fanart = 'http://s2.dmcdn.net/JHwgw/1280x720-HSm.jpg'
        info = 'Novelas en Fusion Request'
    ...
    for match in matches:
        ...
        info = 'Karaoke en Fusion Request'
    ...
    if (kb.isConfirmed()):
        ...
        dialog = xbmcgui.Dialog()
        dialog.notification("Fusion Request", 'La Busqueda se cancelo',
